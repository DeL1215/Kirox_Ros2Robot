# robot_config_client.py
# 作用：透過 robotid 呼叫 API，回傳可直接用屬性的設定物件
...
class RobotConfig:
    ...
    @classmethod
    def from_api(cls, robotid: str, url: str = API_URL, timeout: float = 6.0) -> "RobotConfig":
...
def get_robot_config(robotid: str, url: str = API_URL, timeout: float = 6.0) -> RobotConfig:
